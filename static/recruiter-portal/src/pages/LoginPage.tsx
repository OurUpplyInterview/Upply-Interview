    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{
            fontSize: 16, fontWeight: 700, letterSpacing: '.18em',
            textTransform: 'uppercase', color: '#3ECFA0', marginBottom: 16,
          }}>
            Welcome to
          </div>
          <div style={{
            fontSize: 68, fontWeight: 800, color: '#fff',
            lineHeight: 1.0, letterSpacing: '-3px', marginBottom: 28,
          }}>
            Recruiter<br />Portal
          </div>
          <div style={{
            width: 56, height: 3,
            background: 'linear-gradient(90deg, #3ECFA0, transparent)',
      ...
      <div style={{
        ...
        <div style={{ width: '100%', animation: 'fadeUp .4s ease both' }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <h2 style={{ fontSize: 24, fontWeight: 800, color: '#1E1D4C', marginBottom: 6 }}>
              Sign in
            </h2>
            <p style={{ fontSize: 13, color: '#9998B8' }}>
          ...
          {error && (
            <div style={{
              ...
              background: '#FCE8E8', border: '1px solid #F7C1C1',
              borderRadius: 8, fontSize: 13, color: '#E85555',
            }}>
              {error}
            </div>
          )}
